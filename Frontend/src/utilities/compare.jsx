...
export function compareObjectsManually2(t, s) {
    ...
    {
      result[key]=[t[key],s[key],'']    // the NON-GRADED fields. WE NEED TO REVIEW THIS WITH CLIENT BECAUSE THEY GRADE SOME OF THEM
    }
    else{
      result[key] = [t[key], s[key],t[key] === s[key]?1:0];  // all the others, assigning 1 point per correct field
    }
    });
    return result;
  }
