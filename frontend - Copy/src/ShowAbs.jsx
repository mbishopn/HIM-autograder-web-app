...
export default function ShowAbs({ records }) {
  ...
  // let tArr=records.filter(x=>x['CoderNumber']==='100719')
  ...
  //             if(abs['LastName']==='Emmanuel')
  //             console.log(abs['zzAbstractLink']," ",abs['CoderNumberDesc']," ",abs['ChartNumber'])
  //         });
  ...
  // useEffect(() => {
  //     getAbs("anojini","",1,"ackerman").then((result)=>setRecords(result))
  //   }, []);
